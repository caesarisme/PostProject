...
class OptionsDetector(ImgGenerator):
    def __init__(self, options = {}):
        ...
        # outputs 1
        self.CLASS_REGION = options.get("class_region", ["Казахстан", "Белоруссия", "Киргизия", "Таджикистан", "Узбекистан", "Астана", "Алматы", "Актау", "Актобе","Атырау","Караганда", "Костанай", "Кызылорда", "Павлодар", "Петропавловск", "Семей", "Тараз", "Уральск", "Туркестан", "Кокшетау", "Шымкент", "Россия", "Украина", "Абхазия", "Южная", "Молдавия", "Акмолинская", "Алматинская", "Мангистауская", "Актюбинская", "Атырауская", "Карагандинская", "Костанайская", "Кызылординская", "Павлодарская", "Северно-Казахстанская", "Восточно-Казахстанская", "Жамбыльская", "Западно-Казахстанская", "Туркестанская", "Усть-Каменогорск", "Южно-Казахстанская"])
    ...
    def load(self, path_to_model, options={}, verbose = 0):
        if path_to_model == "latest":
            ...
            path_to_model   = "weights/handwritten_options_2019_10_28.h5"
            options["class_region"] = ["Казахстан", "Белоруссия", "Киргизия", "Таджикистан", "Узбекистан", "Астана", "Алматы", "Актау", "Актобе","Атырау","Караганда", "Костанай", "Кызылорда", "Павлодар", "Петропавловск", "Семей", "Тараз", "Уральск", "Туркестан", "Кокшетау", "Шымкент", "Россия", "Украина", "Абхазия", "Южная", "Молдавия", "Акмолинская", "Алматинская", "Мангистауская", "Актюбинская", "Атырауская", "Карагандинская", "Костанайская", "Кызылординская", "Павлодарская", "Северно-Казахстанская", "Восточно-Казахстанская", "Жамбыльская", "Западно-Казахстанская", "Туркестанская", "Усть-Каменогорск", "Южно-Казахстанская"]
    ...
    def predict(self, imgs):
        ...
        i=0
        for img in imgs:
            cv2.imwrite("pict/q"+str(i)+".jpg", img )
